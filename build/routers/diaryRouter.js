...
diaryRouter.route("/:id(((19|20)\\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\\d|3[01])))").get(_diaryController.getEdit).post(_middlewares.uploadFiles.single("ticket"), _diaryController.postEdit);
